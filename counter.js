...
(function() {
    ...
    const STORAGE_KEYS = {
        counter: 'nke_counter',
        visitors: 'nke_visitors',
        clients: 'nke_clients',
        startTime: 'nke_start_time',
        lastUpdate: 'nke_last_update',
        counterHash: 'nke_counter_hash'
    };

    // Соль для хеша
    const SALT = 'nke_salt_2026_secure';
    ...
    function updateMetadata(visitors, clients, startTime) {
        ...
        script.textContent = JSON.stringify({
            ...
            "@type": "WebSite",
            "name": "NKE Token",
            "description": "NKE is the athletic token of the BYT ecosystem with Swoosh platform.",
            "statistics": {
                "visitors": visitors,
                "clients": clients,
